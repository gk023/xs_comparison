...
TGraph *g1 = new TGraph("nucl_th_rfg/xsec_dsigma_diff_Anu_1g_15_NC_reduced.out");
...
TFile* f1 = TFile::Open("neut-Anu-rfg.root");
TTree* tree1 = (TTree*)f1->Get("FlatTree_VARS");
TFile* f2 = TFile::Open("genie-Anu-rfg.root");
...
newpad->SaveAs("./diffxs_1g_15_Anu_rfg.png");
