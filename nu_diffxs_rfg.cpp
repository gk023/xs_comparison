...
TGraph *g1 = new TGraph("nucl_th_rfg/xsec_dsigma_diff_nu_1g_15_NC_reduced.out");

g1->Draw("AL");

g1->GetXaxis()->SetLimits(0.0,600.0);
g1->GetYaxis()->SetRangeUser(0.0,20.0);
...
TFile* f1 = TFile::Open("neut-nu-rfg.root");
TTree* tree1 = (TTree*)f1->Get("FlatTree_VARS");
TFile* f2 = TFile::Open("genie-nu-rfg.root");
TTree* tree2 = (TTree*)f2->Get("FlatTree_VARS");
//************************************************************************************
...
//Make a histogram with cuts in theta, energy
//fScaleFactor_alttest for units of 10e-38 cm^2
...
h1->Scale(15.); //"Truth cut" on energy that scales by energy range used to generate and divides by bin width

h1->SetLineColor(kGreen);
h1->SetLineWidth(3);

//Same thing but for 2nd root file
tree2->Draw("1000*q0>>h2(30,0,600)","10e41*fScaleFactor_alttest/(20.*2.*TMath::Pi()*(TMath::Cos(12.5*TMath::Pi()/180.)-TMath::Cos(17.5*TMath::Pi()/180.)))*( (TMath::Abs(Mode)>50)&&(TMath::Abs(TMath::ACos(CosLep)/TMath::Pi()*180. - 15.)< 2.5) &&(TMath::Abs(Enu_true-1.0) < 0.01))","EHIST && same");
...
leg->AddEntry(g1,"RFG","l");
leg->AddEntry(h1,"N-RFG","l");
leg->AddEntry(h2,"G-RFG","l");
leg->Draw("same");
...
newpad->SaveAs("./diffxs_1g_15_nu_rfg.png");
